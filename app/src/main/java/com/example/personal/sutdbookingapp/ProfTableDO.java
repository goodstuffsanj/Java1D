...
public class ProfTableDO {
    ...
    @DynamoDBIndexHashKey(attributeName = "ProfID", globalSecondaryIndexName = "ProfID")
    ...
    @DynamoDBRangeKey(attributeName = "ProfPassword")
    ...
    @DynamoDBAttribute(attributeName = "t113--12")
    public String getT11312() {
        return _t11312;
    }

    public void setT11312(final String _t11312) {
        this._t11312 = _t11312;
    }
