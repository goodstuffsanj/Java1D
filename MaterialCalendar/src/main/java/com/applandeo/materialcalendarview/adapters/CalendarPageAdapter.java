...
public class CalendarPageAdapter extends PagerAdapter {
    ...
    public void callDayRowSelectOneDay(View view) {
        new DayRowClickListener(this, mCalendarProperties, mPageMonth).callSelectOneDay(view);
    }
    ...
    private void informDatePicker() {
        if (mCalendarProperties.getOnSelectionAbilityListener() != null) {
            ...
            Log.i("xxx", "informDatePicker: " + mCalendarProperties.getSelectedDays().size());
        }
    }
